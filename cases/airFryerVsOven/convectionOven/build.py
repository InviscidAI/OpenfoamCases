...
NAME='convection_oven'
CFG={'W': 0.45, 'H': 0.4, 'z': 0.01, 'inlets': [(0.07, 0.13), (0.27, 0.33)], 'outlet': (0.17, 0.23), 'obstacles': [(0, 0, 0.005, 0.07), (0, 0.13, 0.005, 0.14), (0, 0.33, 0.005, 0.07), (0.445, 0, 0.005, 0.17), (0.445, 0.23, 0.005, 0.17), (0.14, 0.105, 0.05, 0.025), (0.26, 0.105, 0.05, 0.025), (0.14, 0.23, 0.05, 0.025), (0.26, 0.23, 0.05, 0.025)]}
...
def mesh():
    ...
    for _,tag in gmsh.model.getEntities(2):
        ...
        if NAME=='convection_oven' and xmax-xmin<tol and cx>W-.006:
